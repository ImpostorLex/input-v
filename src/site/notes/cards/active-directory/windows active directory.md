...
| File                                                                                                       | dg-publish |
| ---------------------------------------------------------------------------------------------------------- | ---------- |
| [[cards/active-directory/Active Directory Certificate Services\|Active Directory Certificate Services]] | true       |
| [[cards/active-directory/Active Directory\|Active Directory]]                                           | true       |
| [[cards/active-directory/DC Sync\|DC Sync]]                                                             | true       |
| [[cards/active-directory/Domain Trusts\|Domain Trusts]]                                                 | true       |
| [[cards/active-directory/Group Policy Objects\|Group Policy Objects]]                                   | true       |
| [[cards/active-directory/Group Policy Preferences (GPP)\|Group Policy Preferences (GPP)]]               | true       |
| [[cards/active-directory/Kerberos Delegation\|Kerberos Delegation]]                                     | true       |
...
| [[cards/active-directory/NTDS Database Structure\|NTDS Database Structure]]                             | true       |
| [[cards/active-directory/Nested Group Concept\|Nested Group Concept]]                                   | true       |
| [[cards/active-directory/New Technology LAN Manager (NTLM)\|New Technology LAN Manager (NTLM)]]         | true       |
| [[cards/active-directory/SID History Concept\|SID History Concept]]                                     | true       |
| [[cards/active-directory/SYSVOL\|SYSVOL]]                                                               | true       |
| [[cards/active-directory/Server Message Block (SMB)\|Server Message Block (SMB)]]                       | true       |
| [[cards/red-team/Golden Ticket vs Silver Ticket\|Golden Ticket vs Silver Ticket]]                       | true       |
...
> | [[cards/red-team/Exploiting Active Directory\|Exploiting Active Directory]]                                                           | true       |
...
> | [[cards/red-team/lateral movement and pivoting\|lateral movement and pivoting]]                                                       | true       |
> 
{ .block-language-dataview}
